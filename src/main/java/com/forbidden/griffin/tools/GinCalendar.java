...
public class GinCalendar {
    private static final String TAG = "GinUCalendar";
    /**
     * 完整的日期时间格式
     */
    ...
    public static String formatWithString(String src, String srcFormat, String targetFormat) {
        ...
        try {
            ...
            GinLog.e(TAG, "src=" + src + "  " + srcFormat + "  " + targetFormat);
            e.printStackTrace();
        }
        return null;
    }
    ...
    public static String formatDateTimeWithString(String srcDate, String srcDateFormat, String targetFormat) {
        ...
        try {
            ...
            GinLog.e(TAG, "srcDate:" + srcDate + "  srcDateFormat:" + srcDateFormat + "   targetFormat" + targetFormat);
            e.printStackTrace();
        }
        return null;
    }
